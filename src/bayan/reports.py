...
BS_ASSET_ROWS = [
    ...
    # 1203 «НӨАТ-ын авлага» нь худалдааны авлага БИШ тул доорх татварын
    # мөрөнд ордог (partners.post_invoice 1205 → 1203 болж өөрчлөгдөхөд
    # энэ бүлэглэлт хоцорч, НӨАТ-ын авлага дансны авлагад тоологддог байв)
    ("Дансны авлага",                    ("1201", "1202", "1206", "1207", "1209")),
    ("Татвар, НДШ-ийн авлага",           ("1203", "1204", "1205")),
